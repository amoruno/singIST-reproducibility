...
save(df_gene, file = "~/singIST-reproducibility/4_graphical_output/exported_results/df_gene.RData")
save(df_FC, file = "~/singIST-reproducibility/4_graphical_output/exported_results/df_FC.RData")
